...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 bee.py train --dataset=/home/datascience/Workspace/maskRcnn/Mask_RCNN-master/samples/bee/dataset --weights=coco
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image(
                "bee",  ## for a single class just add the name here
